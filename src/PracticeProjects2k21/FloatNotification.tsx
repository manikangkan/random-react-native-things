...
const bg =
  'https://images.unsplash.com/photo-1621247033710-454b4e1d6f2e?ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8bW9uc29vbnxlbnwwfDF8MHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=600&q=60';
const userProf =
...
function Notifications({item, onHide}) {
...
//         ],
//       }}>
//       <Text style={styles.textContainer}>{props.message}</Text>
//     </Animated.View>
//   );
// };
...
//       <View style={styles.containerBoom}>
...
//         }}>
//         <Text style={styles.btnText}>push message</Text>
//       </TouchableOpacity>
//       <StatusBar hidden={true} />
//     </View>
//   );
